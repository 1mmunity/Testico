    ...
    <div className='py-4 shadow-md bg-black px-5 bg-opacity-25 backdrop-blur-lg fixed top-0 z-10 w-full'>
      <div className='inline-flex items-center w-full'>
        ...
        <div className='inline-flex items-center'>
          <a className='w-10 h-10 fa fa-github text-2xl hover:bg-gray-300/5 duration-150 text-gray-400 hover:text-gray-300 inline-flex items-center justify-center mr-4 rounded-lg' href='https://github.com/1mmunity/Testico'></a>
